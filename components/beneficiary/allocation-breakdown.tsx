  ...
  return (
    <div className="space-y-12">
      <div className="relative">
        <p className="text-muted text-xs absolute right-[41%] top-12">Assigned Allocation</p>
      ...
      <div className="bg-card border rounded-md text-muted-foreground text-sm p-2 flex items-start space-x-2">
        <InfoCircleIcon />
        <p>In the event of inactivity or death, allocated tokens in your wallet will be transferred to your beneficiary’s wallet address.</p>
      </div>
